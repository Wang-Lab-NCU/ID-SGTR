...
if __name__ == "__main__":
    ...
    BASE_DIR = r"D:\Code\jupyter\knowledge_graph\data_output\dataset\musique\ds1000"
    ...
    if os.path.exists(QA_FILE):
        ...
        # Hybrid weights: (w_name, w_desc, w_exact, w_bm25)
        # Here the 0.3 lexical weight makes exact-matching entities score significantly higher
        ...
        for i, row in df_qa.head(10).iterrows():
            ...
            # Call linker
            df_res = linker.link(q, context_id=None, top_k=20, lambda_weights=HYBRID_WEIGHTS)
