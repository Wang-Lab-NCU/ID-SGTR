...
class ID_SGTR_Reasoning_Engine:
    ...
    def _get_top_chunks(self, candidate_cids, query_vec, top_k=5, min_score=0.25):
        """Filter and rank candidate text chunks based on cosine similarity"""
    ...
    def step2_semantic_anchoring(self, query, context_id, query_vec=None, top_k=10):
        """Semantic anchoring: find entities contained in the query and related starting points"""
        with self.gpu_lock:
...
if __name__ == "__main__":
    ...
    # --- Mode B: multi-threaded batch processing (logs will be messy, set verbose=False) ---
