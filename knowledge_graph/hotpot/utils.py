...
# ==========================================
# Read all keys from environment variables, split by comma, automatically strip spaces and remove empty values
_siliconflow_keys = [
    k.strip() for k in os.getenv('SILICONFLOW_API_KEYS-1', '').split(',') if k.strip()
]
