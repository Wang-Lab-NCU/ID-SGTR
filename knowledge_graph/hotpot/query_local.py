...
"""
    ...
    def solve(self, query, context_id, verbose=True, mode='full'):
        ...
        seeds = self.step2_semantic_anchoring(query, ctx_id_str) 
...
if __name__ == "__main__":
    ...
    #     # 👇 Please add these two lines to let me see its true structure
    #     print("\n🔍 [Diagnostic] chunk_df columns:", df_chunk.columns.tolist())
    #     print("🔍 [Diagnostic] First row data sample:\n", df_chunk.head(1).to_dict('records'))
